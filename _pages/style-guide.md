...
Articles in [{{ site.title }}]({{ site.url }}) are written in Markdown which are generated in standard HTML using [Jekyll](//jekyllrb.com/).

This style guide is written in Markdown, the raw file is available [here](//raw.githubusercontent.com/slowprog/slowprog.github.io/master/_pages/style-guide.md).
...
![{{ site.title }}](//placehold.it/800x400)
